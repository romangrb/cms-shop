                ...
                <div <?php $my_close_open_win_id = 'bk_settings_form_fields'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle' ,'booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
                    <h3 class='hndle'><span><?php _e('Form fields labels' ,'booking'); ?></span></h3><div class="inside">
                        ...
                        if (isset( $_POST['Submit'] )) {
                            ...
                            if (isset( $_POST['booking_form_field_active7'] )) $booking_form_field_active7 = 'On';
                            else                                               $booking_form_field_active7 = 'Off';
                            update_bk_option( 'booking_form_field_active7',    $booking_form_field_active7 );

                            if (isset( $_POST['booking_form_field_required7'] )) $booking_form_field_required7 = 'On';
                            else                                                 $booking_form_field_required7 = 'Off';
                            update_bk_option( 'booking_form_field_required7',    $booking_form_field_required7 );

                            update_bk_option( 'booking_form_field_label7',    $_POST['booking_form_field_label7'] );
                        }
                        $booking_form_field_active7 = get_bk_option( 'booking_form_field_active7');
                        $booking_form_field_required7 = get_bk_option( 'booking_form_field_required7');
                        ...
                        <div class="control-group">
                          <label for="name" class="control-label" style="font-weight:bold;"><?php _e('Field Label' ,'booking'); ?> #7:</label>
                          <div class="controls"> 

                            <input type="text" class="large-text" 
                                   name="booking_form_field_label7" value="<?php echo $booking_form_field_label7; ?>">&nbsp;&nbsp;&nbsp;

                            <label class="checkbox inline">
                                <input type="checkbox"  name="booking_form_field_active7"
                                    <?php if ($booking_form_field_active7 == 'On') {echo ' checked="checked" ';} ?>  
                                    value="<?php echo $booking_form_field_active7; ?>" >
                                <?php _e('Active' ,'booking'); ?>
                            </label> 

                            <label class="checkbox inline">
                                <input type="checkbox"  name="booking_form_field_required7"
                                    <?php if ($booking_form_field_required7 == 'On') {echo ' checked="checked" ';} ?>  
                                    value="<?php echo $booking_form_field_required7; ?>" >
                                <?php _e('Required' ,'booking'); ?>
                            </label> 
