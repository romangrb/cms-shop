...
//                $my_result .= '<div class="wpdev_hint_with_text "><div class="block_pending datepick-unselectable date_user_unavailable" style="background-color:transparent;">'.$text_for_day_cell.'</div><div class="block_text">- '.__('Unavailable', 'booking').'</div></div>';
    ...
    function get_booking_form($my_boook_type) {
        ...
        if (function_exists('icl_translate')) 
            $booking_form_field_label7 = icl_translate( 'wpml_custom', 'wpbc_custom_form_field_label7', $booking_form_field_label7);
        ...
        if (function_exists('icl_translate')) 
            $booking_form_field_label7 = icl_translate( 'wpml_custom', 'wpbc_custom_form_field_label7', $booking_form_field_label7);
        $booking_form_field_values7     = get_bk_option( 'booking_form_field_values7' );
...
//debuge($attr);
    ...
    function wpdev_booking_activate() {
        ...
        /*TEST FIELD START*/
        add_bk_option( 'booking_form_field_active7' ,'On');
        add_bk_option( 'booking_form_field_required7' ,'Off');
        add_bk_option( 'booking_form_field_label7' ,'TEST');
        /*TEST FIELD END*/
    ...
    function wpdev_booking_deactivate() {
        ...
        if ($is_delete_if_deactive == 'On') {
            ...
            // TEST
            delete_bk_option( 'booking_form_field_active7' );
            delete_bk_option( 'booking_form_field_required7' );
            delete_bk_option( 'booking_form_field_label7' );
            delete_bk_option( 'booking_form_field_values7' );
            // END TEST
